                ...
                button.addEventListener('click', async () => {
                    ...
                    arrLangs.forEach(item => {
                        ...
                        div.innerHTML = `
                            ...
                            <label class="form-check-label" for=${item.lang}><img class="img-thumbnail" src="https://steeimages.com/graphics/flags/${ item.lang }.svg"> ${ item.name }</label>
                        `;
                        if(i == 3) {
                            i=0;
                            rowId++;
                    ...
                    /*var inputOptions = new Promise((resolve) => {
                        ...
                        arrLangs.forEach(item => {
                            lang[item.lang] = `<div><img src="https://steemitimages.com/graphics/flags/${ item.lang }.svg" height="30" width="40" style="border-radius: 0.25em">${ item.name }</div>`;
                        });
                        resolve(lang)
                    })
                    const {
